...
export default function SignInPage() {
  return (
    <div className="grid flex-grow items-center px-4 w-full bg-zinc-100 sm:justify-center">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="px-4 py-10 space-y-6 w-full bg-white rounded-2xl ring-1 shadow-md ring-black/5 sm:w-96 sm:px-8"
        >
