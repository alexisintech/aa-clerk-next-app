...
export function UserDetails() {
  ...
  return (
    ...
    >
      ...
      {isLoaded && user ? (
        jsonOutput ? (
          <div className="overflow-scroll pb-6 max-h-96">
...
function CopyButton(props: { text: string }) {
  ...
  return (
    <>
      ...
      <div
        className={classNames({
          'absolute z-10 p-2 text-xs text-white bg-gray-900 rounded shadow-sm transition-all ease-in-out translate-x-60 shadow-gray-500':
            true,
          'opacity-0 translate-y-10': !tooltipShown,
